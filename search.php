...
<div class="moddho">
    ...
    <div class="container middle xyz boundary">
        <div class="yo" >
            <h1 class="text-center"style="font-weight: bold;">Scholarship List <h2 style="color:red"> (SEMESTER WISE)</h2> </h1>
            <p>(Name of the students who are applying for Scholarship in this semester)</p>
        ...
        <div class="container abc">            
                <table class="table table-hover table-bordered ">
                  ...
                  <tbody>
                        ...
                        <?php 
                        // Here
                        $searchtext = $_REQUEST['searchbody'];
                        $query = "SELECT * FROM `scholarshiplist` WHERE semester = '$searchtext'";
